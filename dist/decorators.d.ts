...
export declare class DecoratorTypes {
    ...
    static FULLY_QUALIFIED_DOMAIN_NAME: string;
...
export declare function Contains(value: string, validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
...
export declare function Creditcard(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
export declare function Currency(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
...
export declare function FullyQualifiedDomainName(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
export declare function HexColor(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
export declare function IsIP(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
export declare function Hexadecimal(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
export declare function IsISBN(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
...
export declare function IsUUID(validatorOptions?: IValidatorOptions): (target: Object, propertyName: string) => void;
